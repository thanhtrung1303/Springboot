...
public class JobController {
    ...
    public String updateJob(@PathVariable String id, @ModelAttribute JobRequest request) {
        LocalDateTime UpdateTime = jobRepository.getById(id).getCreated_at();
        Job job = new Job(id, request.employer(), request.title(), request.description(), request.city(),
    ...
    public String addNewJob(@ModelAttribute JobRequest request) {
        ...
        Job job = new Job(uuid, request.employer(), request.title(), request.description(), request.city(),
    ...
    {
    String uuid = UUID.randomUUID().toString();
    Applicant applicant = new Applicant(uuid, applicantRequest.job(),
