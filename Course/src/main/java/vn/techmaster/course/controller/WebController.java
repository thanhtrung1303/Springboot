...
public class WebController {
    ...
    @GetMapping("/khoa-hoc/topic/{id}")
    public String getCourseByTopic(@PathVariable int id, Model model) {
        model.addAttribute("topics", topicRepository.findAll());
        model.addAttribute("courses", courseRepository.findAllByTopics_Id(id));
        return "web/course-list";
    ...
    public String getDetailCoursePage(@PathVariable int id, Model model) {
